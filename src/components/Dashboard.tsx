        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button 
              ...
              className="p-1.5 sm:p-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors"
            >
          ...
          {!activeCourseId ? (
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                      ...
                      <div className="relative w-full sm:w-auto">
                        ...
                        <input 
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-2 text-sm focus:outline-none focus:border-blue-500 transition-all"
                          value={searchQuery}
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-white/5">
                ...
                <div className="flex items-center gap-4">
                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest whitespace-nowrap">{selectedLesson.duration} Read</span>
                  <div className="w-px h-4 bg-white/10" />
                  <span className="text-[10px] font-bold text-blue-400 uppercase tracking-widest truncate">Module: {selectedModule.title}</span>
                </div>
              </div>
